...
echo_and_run cd "/home/ubuntu20-04/ros1_workspaces/smb_ws/src/smb_test/smb_highlevel_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu20-04/ros1_workspaces/smb_ws/src/smb_test/smb_highlevel_controller/setup.py" \
     \
    build --build-base "/home/ubuntu20-04/ros1_workspaces/smb_ws/build/smb_test/smb_highlevel_controller" \
    install \
    --root="${DESTDIR-/}" \
